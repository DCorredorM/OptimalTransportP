...
class Measure:
	def __init__(self, measure_space: 'MeasureSpace' = None):
...
class DiscreteMeasure(Measure):
	def __init__(self, support: list, mass: list, measure_space: 'MeasureSpace' = None):
		self.histogram = dict(zip(support, mass))
		self.support = support
		self.mass = mass
